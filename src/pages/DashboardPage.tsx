...
const DashboardPage = () => {
  ...
  useEffect(() => {
    ...
    if (history.length === 0) {
      // Seed demo history for display
      const demo: TestRecord[] = [
            ...
            <div className="bg-warning/10 border-b border-warning/30 px-6 py-3">
              <div className="max-w-5xl mx-auto flex items-center justify-between gap-4">
                ...
                <button
                  ...
                  className="flex-shrink-0 p-1 rounded-full hover:bg-warning/20 transition-colors"
                >
        ...
        <div className="relative max-w-5xl mx-auto px-6 py-16">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-lg">
              Your AI-powered biometric health companion. Track vital signs, monitor neurological patterns, and gain actionable insights through advanced multi-modal analysis.
            </p>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        >
          ...
          <p className="text-muted-foreground mb-6">
            Begin a new assessment or continue with specific test modules to monitor your health.
          </p>
              ...
              {sortedHistory.map((record, idx) => (
                ...
                >
                  <div className="w-10 h-10 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0">
                    {record.type === "Full System Analysis" ? (
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className={`text-xs px-2 py-0.5 rounded-full border ${riskColor(record.riskLevel)}`}>
